...
def test_a_star_finds_shortest_path_manhattan_graph1(valid_graph1):
    result = a_star(graph=valid_graph1, start_node_index=0, end_node_index=4, heuristic_distance=manhattan_distance)
...
def test_a_star_finds_shortest_path_manhattan_graph2(valid_graph2):
    result = a_star(graph=valid_graph2, start_node_index=0, end_node_index=4, heuristic_distance=manhattan_distance)
...
def test_a_star_with_no_path_manhattan(valid_nodes):
    with pytest.raises(Exception):
        a_star(graph=Graph(valid_nodes, ()), start_node_index=0, end_node_index=3, heuristic_distance=manhattan_distance)
